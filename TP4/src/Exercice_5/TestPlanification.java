...
public class TestPlanification {
    public static void main(String[] args) {
        ...
        System.out.println("L'étape nommée " + testDuneEtapeSeule.getDescriptionPrevue() + " a une durée égale à " + testDuneEtapeSeule.donneeDureePrevueHHMM().format(DateTimeFormatter.ofPattern("HH:mm")));
        ...
        for (MiniExcursionPlanifiee miniExc : monPlanningJournee.getExcusionPlanifiees()) {
            System.out.println(miniExc.getMiniExcursion().getLibelleMiniExcursion() + " a une durée égale à " + miniExc.getMiniExcursion().donneDureePrevueHHMM().format(DateTimeFormatter.ofPattern("HH:mm")));
        }
    }
}
